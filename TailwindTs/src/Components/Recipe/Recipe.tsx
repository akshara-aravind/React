...
export default function Food(){
    return(
        <>
        <div className="flex justify-between mx-25 p-7">
            <h2 className="font-cursive text-amber-500 font-bold font-sedan text-4xl">Foodie</h2>
            <ul className="flex text-xl gap-5 font-bold font-cursive items-center justify-center">
               <li>Home</li>
               <li>About</li>
               <li>Testimonials</li>
               <li>Conatct</li>
               ...
               <button className='rounded-full bg-white p-2'>Booking Now</button>
            </ul>
        </div>
        <div className="flex">
            <div className="flex flex-col justify-center items-center md:w-1/2">
                
                <h1 className="text-4xl  font-bold font-sedan w-[350px] mx-6 mb-6">Your Favourite Food Delivered Hot & Fresh</h1>
                <h1 className='mb-6 text-zinc-600 w-[350px] mx-6 mb-6"'>Health switcher chefs do all the prep work, like peeding,
                   chopping & marinating, so you can cook a fresh food.
                </h1>
                <button className='p-3 px-8 bg-amber-500 text-white rounded-full '>Order Now <span className='text-xl'>→</span> </button>
            </div>
            <div>
